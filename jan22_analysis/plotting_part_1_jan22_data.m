...
dist = 0:distance_per_pixel:(distance_per_pixel*200);

inc_100 = imread('jan22_mz_inc_100_no_etalon_beam.bmp');
inc_200 = imread('jan22_mz_inc_200_no_etalon_beam.bmp');
inc_300 = imread('jan22_mz_inc_300_no_etalon_beam.bmp');
inc_400 = imread('jan22_mz_inc_400_no_etalon_beam.bmp');
inc_500 = imread('jan22_mz_inc_500_no_etalon_beam.bmp');
...
fit_slope = [0.03228 0.03247 0.02951 0.03118, 0.03027]/(2*pi);
fit_std = ([0.03262, 0.03304, 0.03054, 0.03273, 0.03235] - [0.03193, 0.03189, 0.02847, 0.02963, 0.02819])/(4*pi);
...
sgtitle('Data Taken January 22, 2019 - Fourier Series Curve Fits, 100-500\mu{m}');
...
hold on;
plot(0:1:600, (-6.452e-07)*(0:1:600) + 0.005134, 'b--');
title('Fringe Pattern \Delta{L} Results Curve Fit - January 22 Data','Fontsize',fontsize);
xlabel( 'Measured Path Length Difference(\mu{m})');
ylabel( 'Path Length Difference Prediction From Curve Fit(\mu{m})');

saveas(figure(3),'line_curve_fit_jan22','epsc');
